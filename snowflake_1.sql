...
----------------------------------------
USE ROLE SECURITYADMIN; -- gdzies tutaj cos nie gra na ten moment
CREATE OR REPLACE ROLE LOCAL_ADMIN_ROLE;
GRANT CREATE USER, CREATE ROLE ON ACCOUNT TO ROLE LOCAL_ADMIN_ROLE;
USE ROLE ACCOUNTADMIN;
GRANT OWNERSHIP ON ROLE S_FULL TO ROLE LOCAL_ADMIN_ROLE;
GRANT OWNERSHIP ON ROLE S_READ TO ROLE LOCAL_ADMIN_ROLE;
GRANT OWNERSHIP ON ROLE S_WRITE TO ROLE LOCAL_ADMIN_ROLE;
GRANT OWNERSHIP ON ROLE D_FULL TO ROLE LOCAL_ADMIN_ROLE;
GRANT OWNERSHIP ON ROLE D_USAGE TO ROLE LOCAL_ADMIN_ROLE;
-------------------------
GRANT ROLE D_FULL TO ROLE LOCAL_ADMIN_ROLE;
GRANT ROLE S_FULL TO ROLE LOCAL_ADMIN_ROLE;
GRANT ROLE S_READ TO ROLE LOCAL_ADMIN_ROLE;
GRANT ROLE S_WRITE TO ROLE LOCAL_ADMIN_ROLE;
GRANT ROLE D_FULL TO ROLE LOCAL_ADMIN_ROLE;
GRANT ROLE D_USAGE TO ROLE LOCAL_ADMIN_ROLE;
-------------------------
GRANT ROLE LOCAL_ADMIN_ROLE TO ROLE SYSADMIN;

SHOW GRANTS TO ROLE LOCAL_ADMIN_ROLE;
